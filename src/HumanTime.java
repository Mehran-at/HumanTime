...
public class HumanTime {
    public static void main(String[] args) {
        ...
        LocalDate someDayThisYear = LocalDate.parse("2019-06-09");
        ...
        System.out.println("Next year will be a leap year: " + someDayThisYear.plusYears(1));
        ...
        System.out.println("Right now: " + LocalTime.now());
        ...
        System.out.println("Period in months: " + period.getDays());
